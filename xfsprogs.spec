...
Version  : 5.14.0
Release  : 42
URL      : https://mirrors.kernel.org/pub/linux/utils/fs/xfs/xfsprogs/xfsprogs-5.14.0.tar.xz
Source0  : https://mirrors.kernel.org/pub/linux/utils/fs/xfs/xfsprogs/xfsprogs-5.14.0.tar.xz
...
%prep
%setup -q -n xfsprogs-5.14.0
cd %{_builddir}/xfsprogs-5.14.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1637607247
...
cp %{_builddir}/xfsprogs-5.14.0/debian/copyright %{buildroot}/usr/share/package-licenses/xfsprogs/37d59df178f349b9b48ddae9baf7de9fe0c41069
