...
%prep
%setup -q -n xfsprogs-5.14.2
cd %{_builddir}/xfsprogs-5.14.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1639062911
...
cp %{_builddir}/xfsprogs-5.14.2/debian/copyright %{buildroot}/usr/share/package-licenses/xfsprogs/37d59df178f349b9b48ddae9baf7de9fe0c41069
