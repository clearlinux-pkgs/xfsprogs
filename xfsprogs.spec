...
Version  : 6.1.1
Release  : 52
URL      : https://mirrors.kernel.org/pub/linux/utils/fs/xfs/xfsprogs/xfsprogs-6.1.1.tar.xz
Source0  : https://mirrors.kernel.org/pub/linux/utils/fs/xfs/xfsprogs/xfsprogs-6.1.1.tar.xz
...
%prep
%setup -q -n xfsprogs-6.1.1
cd %{_builddir}/xfsprogs-6.1.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1673646948
