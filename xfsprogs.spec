...
Source0  : https://mirrors.kernel.org/pub/linux/utils/fs/xfs/xfsprogs/xfsprogs-6.0.0.tar.xz
...
%prep
%setup -q -n xfsprogs-6.0.0
cd %{_builddir}/xfsprogs-6.0.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1668457271
