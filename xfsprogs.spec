...
Version  : 5.7.0
Release  : 35
URL      : https://cdn.kernel.org/pub/linux/utils/fs/xfs/xfsprogs/xfsprogs-5.7.0.tar.xz
Source0  : https://cdn.kernel.org/pub/linux/utils/fs/xfs/xfsprogs/xfsprogs-5.7.0.tar.xz
...
%prep
%setup -q -n xfsprogs-5.7.0
cd %{_builddir}/xfsprogs-5.7.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1595963738
...
cp %{_builddir}/xfsprogs-5.7.0/debian/copyright %{buildroot}/usr/share/package-licenses/xfsprogs/974121cb7805fb825e64139868b3c0ef663f689c
