...
Version  : 5.14.1
Release  : 43
URL      : https://mirrors.kernel.org/pub/linux/utils/fs/xfs/xfsprogs/xfsprogs-5.14.1.tar.xz
Source0  : https://mirrors.kernel.org/pub/linux/utils/fs/xfs/xfsprogs/xfsprogs-5.14.1.tar.xz
...
%prep
%setup -q -n xfsprogs-5.14.1
cd %{_builddir}/xfsprogs-5.14.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1638523791
...
cp %{_builddir}/xfsprogs-5.14.1/debian/copyright %{buildroot}/usr/share/package-licenses/xfsprogs/37d59df178f349b9b48ddae9baf7de9fe0c41069
